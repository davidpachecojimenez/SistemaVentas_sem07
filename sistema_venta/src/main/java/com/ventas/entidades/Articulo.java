...
public class Articulo {
    ...
    private String categoriaNombre;//otra funcion
    ...
    public String toString() {
        return "Articulo{" + "id=" + getId() + ", categoriaId=" + getCategoriaId() + ", categoriaNombre=" + getCategoriaNombre() + ", codigo=" + getCodigo() + ", nombre=" + getNombre() + ", precioVenta=" + getPrecioVenta() + ", stock=" + getStock() + ", descripcion=" + getDescripcion() + ", imagen=" + getImagen() + ", activo=" + isActivo() + '}';
    }
}
